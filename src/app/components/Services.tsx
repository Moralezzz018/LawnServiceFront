...
export function Services() {
  return (
    <section id="services" className="bg-[#F9FAF4] py-16 lg:py-28">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-6 lg:p-8 shadow-sm hover:shadow-md transition-all duration-300 border-t-4 border-transparent hover:border-[#6B7C2E] group"
            >
